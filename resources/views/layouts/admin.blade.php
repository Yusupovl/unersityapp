        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link" href="#">
                    ...
                    <span>Arizalar</span></a>
            </li> --}}

            {{-- <li class="nav-item">
                <a class="nav-link" href="#">
                    <i style="font-size:18px;" class="fas fa-thin fa-book"></i>
                    <span>Ko'rib chiqilmagan</span></a>
            </li> --}}
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a style="color: white;border-radius:5px;text-decoration:none;" class="button bg-info p-2" href="{{route('asosiyga')}}" >
                                Logout
                            </a>
                            <form id="logout-form" action="{{route('asosiyga')}}" method="GET" class="d-none">
                                @csrf
                            </form>
